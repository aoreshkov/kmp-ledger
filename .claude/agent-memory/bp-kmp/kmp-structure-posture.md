...
description: kmp-ledger's KMP source-set/target/expect-actual/swift-export/BCV posture and which choices are deliberate-and-current (re-verified 2026-07-02 vs Kotlin 2.4.0 docs)
metadata:
  type: project
---

kmp-ledger KMP structure is current against JetBrains guidance for the pinned Kotlin 2.4.0 (re-verified 2026-07-02 against docs dated Mar–May 2026). Durable facts so future audits don't re-derive:
