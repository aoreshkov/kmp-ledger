...
description: Baseline result of the Kotlin/coroutines upstream-currency audits (2026-06-26, re-audited 2026-07-02) — what was checked and found current, so future audits can diff
metadata:
  type: project
---

Full-repo Kotlin-language + kotlinx.coroutines/Flow currency audits against pinned Kotlin 2.4.0 / Coroutines 1.11.0. Outcome both times: code matches current official best practice — no Critical/Should-fix currency gaps.

**Version currency confirmed 2026-07-02:** Kotlin 2.4.0 is the latest stable (released 2026-06-03; 2.4.20 planned Sep 2026, 2.5.0 Dec 2026 per kotlinlang.org/docs/releases.html). kotlinx.coroutines 1.11.0 is the latest stable per GitHub releases. Both pins are fully current — nothing newer to note.
