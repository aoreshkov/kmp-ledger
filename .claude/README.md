...
## Agents (`agents/`)
17 read-only review subagents in two families. Full roster, pairing, color scheme,
and ownership matrix: **[`agents/README.md`](agents/README.md)**.
- **`agents/review/`** — 9 `rv-*` house-rules reviewers (no web).
- **`agents/currency/`** — 8 `bp-*` upstream-currency auditors (web-enabled).
...
- `/review-house` — full house-rules review via the nine `rv-*` agents.
- `/review-currency` — upstream-currency audit via the eight `bp-*` agents.
